...
namespace CatalogoJogos.Controllers.v1
{
    ...
    {
        public readonly IExemploSingleton _exemploSingleton1; //Gera uma instancia do recurso enquanto a API estiver no ar
        public readonly IExemploSingleton _exemploSingleton2;

        public readonly IExemploScoped _exemploScoped1; //Uma instancia que perdura durante toda requisição
        public readonly IExemploScoped _exemploScoped2;

        public readonly IExemploTransient _exemploTransient1;
        public readonly IExemploTransient _exemploTransient2; //Para cada injeção ele gera uma nova instancia
